...
<head>
    ...
    <title>Desarrollo Grupo 3</title>
     <!--<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" 
        rel="stylesheet"
        integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" 
        crossorigin="anonymous">-->

    <link href="<?= base_url('vendor/fontawesome-free/css/all.min.css') ?>" 
        rel="stylesheet" 
        type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Desarrollo - Grupo #3</div>
            </a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('goles'); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('incidencias'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('reportea'); ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Reporte A</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('reporteb'); ?>">
                    <i class="fas fa-fw fa-table"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo '¡Bienvenido, '.session('nombre').' '.session('apellido').'!'; ?></span>
    ...
    <?php echo $this->renderSection('scriptPage'); ?>
