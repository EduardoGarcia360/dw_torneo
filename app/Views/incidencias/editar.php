...
<form action="<?= base_url('incidencias/'.$incidencia['id']); ?>" method="post">
    ...
    <div class="form-group mb-3">
        ...
        <input type="date" class="form-control" id="fecha_suspension" name="fecha_suspension" value="<?= old('fecha_suspension', $incidencia['fecha_suspension']); ?>" <?= ($incidencia['tipo_tarjeta'] == 'R') ? '' : 'disabled'; ?>>
    </div>
