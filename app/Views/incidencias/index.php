...
<h3 class="my-3" id="titulo">Lista de Incidencias</h3>

<a href="<?= base_url('incidencias/new'); ?>" class="btn btn-success mb-3">Agregar Incidencia</a>
...
<table class="table table-hover table-bordered my-3" aria-describedby="titulo">
    <thead class="table-dark">
        <tr>
            ...
            <th scope="col">Fecha de Suspensión</th>
    ...
    <tbody>
        <?php foreach ($incidencias as $incidencia) : ?>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('incidencias/'.$incidencia['id'].'/edit'); ?>" class="btn btn-warning btn-sm me-2">Editar</a>
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                            data-target="#eliminaModal" 
                            data-url="<?= base_url('incidencias/'.$incidencia['id']); ?>"
                            onclick="setDeleteUrl('<?= base_url('incidencias/'.$incidencia['id']); ?>')"
                            >Eliminar</button>
                </td>
            </tr>
        <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Deseas eliminar esta incidencia?</p>
            </div>
